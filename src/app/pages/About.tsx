      ...
      <section className="w-full px-6 lg:px-[6rem] pt-6 md:pt-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            <div>
              ...
              >
                ...
                <p>
                  Based in Shanghai, I've spent the last six years collaborating with architectural studios, avant-garde design agencies, and deep-tech startups. My work often explores generative logic, tangible prototypes, and the evolving symbiosis between human intuition and machine intelligence.
                </p>
              </motion.div>
            </div>
          ...
          <div className="lg:col-span-5">
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1767372273824-e53093e2c06d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaW5pbWFsaXN0JTIwcG9ydHJhaXQlMjBtYW4lMjBhcmNoaXRlY3R1cmV8ZW58MXx8fHwxNzc2NTI2MTY2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" 
                alt="Portrait" 
